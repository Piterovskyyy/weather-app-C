...
struct qt_meta_stringdata_CLASSMainPanelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMainPanelENDCLASS = QtMocHelpers::stringData(
    "MainPanel"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMainPanelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MainPanel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMainPanelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMainPanelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMainPanelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *MainPanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMainPanelENDCLASS.stringdata0))
